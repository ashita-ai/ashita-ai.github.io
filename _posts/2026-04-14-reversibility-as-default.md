...
Health insurance is the clearest case. Cigna used an algorithm called PXDX to screen claims for diagnosis-procedure mismatches. ProPublica found Cigna [denied 300,000 claims in two months](https://www.propublica.org/article/cigna-pxdx-medical-health-insurance-rejection-claims) at 1.2 seconds per claim. Technically, patients could appeal. In practice, roughly [80% of appealed Cigna denials were overturned](https://www.pbs.org/newshour/show/how-algorithms-are-being-used-to-deny-health-insurance-claims-in-bulk), suggesting most were inappropriate. But only about one in five patients appealed at all. The system exploited the asymmetry between the cost of denying (near zero for the insurer) and the cost of appealing (substantial for a sick patient). For most patients, the denial was irreversible in practice.

In February 2024, a Canadian civil tribunal ruled that Air Canada was liable for misinformation its chatbot had given a passenger about bereavement fares. The chatbot told him a discounted fare could be applied retroactively after purchase. It could not. Air Canada's defense was that the chatbot was "a separate legal entity" responsible for its own statements. The tribunal rejected this. The passenger had acted on the output. The output could not be recalled. Air Canada could have built a rollback: a process by which disputed chatbot claims trigger human review and potential fare adjustment before the customer acts. Instead, the system generated outputs with no mechanism for correcting them after the fact. The irreversibility was not technological. It was architectural.

The AI systems making the most consequential decisions are the ones with the least reversibility. Insurance denials at 1.2 seconds per claim. Self-driving decisions at millisecond latency. A chatbot's bereavement fare guidance at the moment a grieving customer is booking a flight. The higher the stakes, the more reversibility matters, and the less of it these systems have.
