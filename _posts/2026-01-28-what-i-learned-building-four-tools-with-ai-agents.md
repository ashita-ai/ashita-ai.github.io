...
**Step 1: Write the CLAUDE.md file.** Before any code, an agent constitution. What the project is. What the agent's role is. What it should always do, what it should ask about first, and what it should never do. The skeleton stayed constant across projects; the guardrails got more specific each time. The [Engram version](https://github.com/ashita-ai/engram/blob/main/CLAUDE.md) is the compact baseline; the [Conduit](https://github.com/ashita-ai/conduit/blob/main/CLAUDE.md) and [Arbiter](https://github.com/ashita-ai/arbiter/blob/main/CLAUDE.md) versions show how it grows under contact.
