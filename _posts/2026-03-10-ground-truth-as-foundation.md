...
This compounds. Most AI memory systems and [RAG pipelines](/blog/the-rag-trap/) extract "important" facts from raw data, then discard the original. Each extraction introduces errors. Each summarization loses detail. The [HaluMem study](https://arxiv.org/abs/2511.03506) found memory system accuracies below 56%. After a few passes, you are querying a game of telephone.
...
The foundation comes first. [Provenance](/blog/the-provenance-imperative/)—how you trace it—is next.
