...
Unity's ad-targeting algorithm ingested corrupted data from a single client in 2022 and lost an estimated [$110 million in revenue](https://www.datachecks.io/post/unity-technologies-110m-ad-targeting-error). The data contract (expected schema, expected value ranges, expected semantic meaning) was not enforced at the boundary. Apple made App Tracking Transparency mandatory in iOS 14.5, unilaterally changing the de facto data contract between its platform and the advertising ecosystem. Meta reported a [$10 billion revenue impact](https://appleinsider.com/articles/22/04/13/apples-privacy-features-will-cost-facebook-128-billion-in-2022) for 2022. In each case, the failure was at the contract boundary. Not in the algorithm. Not in the infrastructure. At the interface.
