...
Enterprise spending tells the same story. [$37 billion](https://menlovc.com/perspective/2025-the-state-of-generative-ai-in-the-enterprise/) went to generative AI in 2025. The entire LLM observability market is around [$500 million](https://market.us/report/llm-observability-platform-market/). A 74x difference.
...
The industry is building at a 74x building-to-seeing ratio, then wondering why 74% struggle to extract value.
...
But the disease was that nobody understood what the AI had written. The alert would not have fixed that. The next bug would have been different, and the next one after that. The industry is spending 74x more on building than on seeing.
