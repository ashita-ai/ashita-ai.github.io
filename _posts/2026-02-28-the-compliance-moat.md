...
FINRA's model risk management framework under [SR 11-7](https://www.federalreserve.gov/supervisionreg/srletters/sr1107.htm) covers any quantitative method that processes input into estimates, which includes LLMs. The EU AI Act mandates [10-year record retention](https://artificialintelligenceact.eu/assessment/eu-ai-act-compliance-checker/) and conformity assessments for high-risk systems, with fines reaching [€35 million or 7% of global annual turnover](https://www.europarl.europa.eu/topics/en/article/20230601STO93804/eu-ai-act-first-regulation-on-artificial-intelligence) and full enforcement beginning August 2026.
